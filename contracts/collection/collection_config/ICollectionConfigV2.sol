...
interface ICollectionConfigV2 {
	...
	function getTraitValue(bytes32 traitKey) external view returns (bytes32);

	function generateNFT(uint genes) external view returns (Types.NFTV2 memory);
}
